...
<body>
	<div>
		...
		<form id="houseForm" name="houseForm"
			action="/clientResourceManager/zulist/myzulist.action" method=post>
			<div class="result-title">
...
<c:forEach items="${userlist.zulist}" var="zulist">
								...
								<td>${userlist.phone}</td>
									...
									<td><a class="link-update"
										href="/clientResourceManager/hetong/zukeseehetong.action?house_id=${zulist.house_id }">查看合同</a>
										&nbsp;&nbsp; <a class="link-del"
										href="/clientResourceManager/applyout/insertapplyout.action?house_id=${zulist.house_id }"
