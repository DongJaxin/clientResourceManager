...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="/clientResourceManager/css/common.css"/>
    ...
    <script type="text/javascript" src="/clientResourceManager/js/jquery-1.8.3.min.js"></script>
    <script type="text/javascript" src="/clientResourceManager/js/jquery-ui-datepicker.js"></script>
    <script type="text/javascript" src="/clientResourceManager/js/jquery.validate.min.js"></script>
    <link rel="stylesheet" type="text/css" href="/clientResourceManager/css/jquery-ui.css"/>
	</script>
	<style type="text/css">
	.sum{
	float:right;
...
<div class="search-wrap">
            <div class="search-content">
                <form action="/clientResourceManager/wrong/findmysolve.action" method="post" name="myform">
								...
								<c:forEach items="${solve}" var="solve">
									<tr
										...
										<td>
													...
													<a class="link-update"
											href="/clientResourceManager/wrong/deletesolve.action?id=${solve.id}"
