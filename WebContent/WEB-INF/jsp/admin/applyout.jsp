...
<h1>退租申请</h1>
	...
	<form id="houseForm" name="houseForm"
		action="/clientResourceManager/applyout/findallapplyout.action"
		method=post >
						 <div class="result-title">
							...
							<tbody>
								...
								<c:forEach items="${applyout}" var="applyout">
									...
									<tr
										...
										<a class="link-update"
											href="/clientResourceManager/applyout/agreeapplyout.action?id=${applyout.id }"
											onclick="return window.confirm('确定要同意退租吗？')">同意</a>
											&nbsp;&nbsp; 
											
											<a class="link-del"
											 href="/clientResourceManager/applyout/refuseapplyout.action?id=${applyout.id }"
											onclick="return window.confirm('确定要拒绝吗？')">拒绝</a>
											</c:when >
											<c:otherwise>
												 <a class="link-del"
											 href="/clientResourceManager/applyout/deleteapplyout.action?id=${applyout.id}"
