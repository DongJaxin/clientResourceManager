							...
							<tbody>
								...
								<c:forEach items="${applylist}" var="apply">
									<tr
										...
										<td>
										<a class="link-update"
											href="/clientResourceManager/zulist/toaddhetong.action?house_id=${apply.house_id}">同意租赁</a>
											&nbsp;&nbsp; 
											<input type="hidden" name="id" value="${houselist.id}"/>
											<a class="link-del"
											 href="/clientResourceManager/refuseapply.action?house_id=${apply.house_id}"
