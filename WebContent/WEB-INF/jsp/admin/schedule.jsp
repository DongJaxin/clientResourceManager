...
<div>
	<form id="houseForm" name="houseForm"
		action="/clientResourceManager/schedule/selectAll.action"
		method=post >
						 <div class="result-title">
							...
							<tbody>
								...
								<c:forEach items="${schedule}" var="schedule">
									<tr
										...
										<td>
										<a class="link-update"
											href="/clientResourceManager/schedule/toupdate.action?id=${schedule.id}">修改</a>
											&nbsp;&nbsp; 
											<input type="hidden" name="id" value="${houselist.id}"/>
											<a class="link-del"
											 href="/clientResourceManager/schedule/deleteschedule.action?id=${schedule.id}"
