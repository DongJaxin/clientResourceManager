...
<h1>在租列表</h1>
	...
	<form id="houseForm" name="houseForm"
		action="/clientResourceManager/zulist/findzulist.action"
		method=post >
						 <div class="result-title">
								...
								<c:forEach items="${zulist}" var="zulist">
									...
									<tr
										...
										<td><a class="link-update"
											href="/clientResourceManager/hetong/seehetong.action?house_id=${zulist.house_id }">查看合同</a>
											&nbsp;&nbsp; 
											
											<a class="link-del"
											 href="/clientResourceManager/hetong/deletehetong.action?house_id=${zulist.house_id }"
